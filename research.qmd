...
![](images/BPEF_Jess.jpeg "Backpack Electrofishing")
*Jess using backpack electrofishing to capture fish in Conger Creek, Arizona (April 2021)*

![](images/roundtail-chub.jpg "Roundtail Chub")
*A roundtail chub (Gila robusta) captured in Burro Creek, Arizona (April 2021)*

![](images/eye-peeling_pic.jpg "Eye Dissection")
*Fish eye lens dissection for stable isotope analysis*


![](images/roundtail-chub-SIA-path.png "Roundtail Chub SIA Path")
*Stable isotope results for a single roundtail chub. Eye lens layers are plotted as individual points from the core (bottom left) to the outer layer (upper right)*
